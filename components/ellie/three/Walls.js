    ...
    <>
      ...
      {data.map((item) => (
        ...
        >
          ...
          <mesh>
            <planeGeometry args={[50, 50]} /> {/* Plane geometry with specified dimensions */}
            <meshNormalMaterial side={THREE.DoubleSide} /> {/* Material for the mesh */}
          </mesh>
        </RigidBody>
      ))}
      ...
      >
        ...
        <mesh receiveShadow> {/* Allow the ground to receive shadows */}
          <planeGeometry args={[100, 50]} /> {/* Plane geometry with specified dimensions */}
